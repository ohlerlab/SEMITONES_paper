...
gsexp = feature_set_values(data, genesets, combtype="median")
del data
gc.collect()
...
fname = f"greenleaf_scRNA_gs_knn_rbf_8e-1_median_escores_{i}.txt"
...
fname = f"greenleaf_scRNA_gs_knn_rbf_8e-1_median_pscores_{i}.txt"
