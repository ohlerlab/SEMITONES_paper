...
pd.DataFrame(times).to_csv("groups_SEMITONES_UMAP_cosine_times_corrected.txt", sep="\t")
pd.DataFrame(times_with_p).to_csv("groups_SEMITONES_UMAP_cosine_timesp_corrected.txt",
                                  sep="\t")