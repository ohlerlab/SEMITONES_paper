...
gsexp = feature_set_values(data, genesets, combtype="interaction")
del data
gc.collect()
...
fname = f"greenleaf_scRNA_gs_knn_rbf_8e-1_interaction_escores_{i}.txt"
...
fname = f"greenleaf_scRNA_gs_knn_rbf_8e-1_interaction_pscores_{i}.txt"
