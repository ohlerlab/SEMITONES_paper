...
pd.DataFrame(times).to_csv("paths_SEMITONES_UMAP_rbf_times_corrected.txt", sep="\t")
pd.DataFrame(times_with_p).to_csv("paths_SEMITONES_UMAP_rbf_timesp_corrected.txt",
                                  sep="\t")