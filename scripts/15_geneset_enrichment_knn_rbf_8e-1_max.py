...
gsexp = feature_set_values(data, genesets, combtype="max")
del data
gc.collect()
...
fname = f"greenleaf_scRNA_gs_knn_rbf_8e-1_max_escores_{i}.txt"
...
fname = f"greenleaf_scRNA_gs_knn_rbf_8e-1_max_pscores_{i}.txt"
